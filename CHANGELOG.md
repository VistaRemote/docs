...
- **1.52.0**：Client `/membership` 轮询 / QR / `providerHint`；Admin Orders 仅 `local_billing` simulate-paid。FR-WAD-52 权益标志 **API 已就绪；当前 viewer Admin 系统页 UI 待补**。勿按 PSP live 验收。
